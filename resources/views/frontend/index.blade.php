...
@section("main-container")
                ...
                <div class="container">
                    <div class="content-wrap">
                        <div class="icon-wrap mb-50">
                            <img src="{{url('frontend/images/banner/style1/brands.png')}}" alt="Images">
                        </div>
                        ...
                        <div class="btn-part">
                            <a class="readon btn-text" href="contact.html">
                                ...
                                <img src="{{url('frontend/images/event.png')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row y-middle">
                            ...
                            <div class="services-item">
                                <div class="services-wrap">
                                    <div class="services-icon">
                                        <img src="{{url('frontend/images/services/main-home/choose/1.png')}}" alt="Services">
                                    </div>
                        ...
                        <div class="col-lg-4 col-md-6 md-mb-30">
                            <div class="services-item">
                                <div class="services-wrap">
                                    <div class="services-icon">
                                        <img src="{{url('frontend/images/services/main-home/choose/2.png')}}" alt="Services">
                                    </div>
                                    <div class="services-text">
            ...
            <!-- About Section Start -->
            <div class="rs-about main-home bg3 pt-120 pb-120 md-pt-80 md-pb-80" id="about">
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-7 pr-55 md-pr-15 md-mb-50">
                            <div class="images-part">
                                <img src="{{url('frontend/images/about/about.png')}}" alt="Images">
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="sec-title">
                                ...
                                <div class="rs-counter about-style">
                                    <div class="row">
                                       <div class="col-lg-6 md-mb-30">
                                           <div class="counter-list">
                                               <div class="counter-icon">
                                                   <img src="{{url('frontend/images/counter/icons/1.png')}}" alt="Counter">
                                               </div>
                                       ...
                                       <div class="col-lg-6">
                                           <div class="counter-list">
                                               <div class="counter-icon">
                                                   <img src="{{url('frontend/images/counter/icons/2.png')}}" alt="Counter">
                                               </div>
                                               <div class="counter-text plus">
                ...
                <div class="container">
                    ...
                    <div class="all-services-section">
                        <div class="services-item">
                            <div class="services-wrap">
                                <div class="services-bottom-img">
                                    <img src="{{url('frontend/images/event/icons/1.png')}}" alt="Event">
                                </div>
                        ...
                        <div class="services-item">
                            <div class="services-wrap">
                                <div class="services-bottom-img">
                                    <img src="{{url('frontend/images/event/icons/2.png')}}" alt="Event">
                                </div>
                                <div class="services-part">
                                    <div class="services-icon">
                                        <img src="{{url('frontend/images/event/icons/2.png')}}" alt="Event">
                        ...
                        <div class="services-item">
                            <div class="services-wrap">
                                <div class="services-bottom-img">
                                    <img src="{{url('frontend/images/event/icons/3.png')}}" alt="Event">
                                </div>
                                <div class="services-part">
                                    <div class="services-icon">
                                        <img src="{{url('frontend/images/event/icons/3.png')}}" alt="Event">
                        ...
                        <div class="services-item">
                            <div class="services-wrap">
                                <div class="services-bottom-img">
                                    <img src="{{url('frontend/images/event/icons/4.png')}}" alt="Event">
                                </div>
                                <div class="services-part">
                                    <div class="services-icon">
                                        <img src="{{url('frontend/images/event/icons/4.png')}}" alt="Event">
                        ...
                        <div class="services-item">
                            <div class="services-wrap">
                                <div class="services-bottom-img">
                                    <img src="{{url('frontend/images/event/icons/5.png')}}" alt="Event">
                                </div>
                                <div class="services-part">
                                    <div class="services-icon">
                                        <img src="{{url('frontend/images/event/icons/5.png')}}" alt="Event">
            ...
            <!-- Team Section Start -->
            <div class="rs-team style1 bg5 pt-110 pb-120 md-pt-70 md-pb-80" id="speaker">
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/1.jpg')}}" alt="Team"></a>
                        ...
                        <div class="col-lg-3 col-md-6 mb-35">
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/2.jpg')}}" alt="Team"></a>
                                        <div class="team-content text-center">
                        ...
                        <div class="col-lg-3 col-md-6 mb-35">
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/3.jpg')}}" alt="Team"></a>
                                        <div class="team-content text-center">
                        ...
                        <div class="col-lg-3 col-md-6 mb-35">
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/4.jpg')}}" alt="Team"></a>
                                        <div class="team-content text-center">
                        ...
                        <div class="col-lg-3 col-md-6 md-mb-35">
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/5.jpg')}}" alt="Team"></a>
                                        <div class="team-content text-center">
                        ...
                        <div class="col-lg-3 col-md-6 md-mb-35">
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/6.jpg')}}" alt="Team"></a>
                                        <div class="team-content text-center">
                        ...
                        <div class="col-lg-3 col-md-6 sm-mb-35">
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/7.jpg')}}" alt="Team"></a>
                                        <div class="team-content text-center">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="team-item">
                                <div class="team-inner-wrap">
                                    <div class="images-wrap">
                                        <a href="speaker-single.html"><img src="{{url('frontend/images/team/8.jpg')}}" alt="Team"></a>
                                        <div class="team-content text-center">
                                       ...
                                       <div class="row">
                                           ...
                                           <div class="events-items col-lg-6">                                   
                                                <div class="event-author">                                                
                                                    ...
                                                    <div class="speak-image-btm">
                                                        <div class="speak-image">
                                                            <div class="tooltip"><a href="#"><img src="{{url('frontend/images/tab/3.jpg')}}"alt="Images"></a>
            ...
            <div class="rs-pricing main-home bg7 pt-120 pb-120 md-pt-75 md-pb-80">
                <div class="container">
                    <div class="row">
                                        ...
                                        <div class="top-shape"></div>
                                            <div class="price-list-text">
                                                <div class="price-list-header">
                                                    <span class="price-list-title">B2B Communication</span>
                                                </div>
                                                <p class="price-list">Silver Pass</p>
                                                <span class="event-date">The decade that brought</span>
                                            </div>
                                            <div class="price-list-price">
                                                <span>$20</span>
                                            </div>
                                            <div class="btn-part">
                                                <a class="readon btn-text buy-now" href="contact.html">
                                                    <span>Buy Now</span>
                                                </a>
                                            </div>
                                ...
                                <li class="price-list mb-30">
                                    <div class="price-grid-item">            
                                        <div class="top-shape"></div>
                                            <div class="price-list-text">
                                                <div class="price-list-header">
                                                    <span class="price-list-title">Marketing Strategy</span>
                                                </div>
                                                <p class="price-list">Gold Pass</p>
                                                <span class="event-date">The decade that brought</span>
                                            </div>
                                            <div class="price-list-price">
                                                <span>$36</span>
                                ...
                                <li class="price-list">
                                    <div class="price-grid-item">            
                                        <div class="top-shape"></div>
                                            <div class="price-list-text">
                                                <div class="price-list-header">
                                                    <span class="price-list-title">Become Leader</span>
                                                </div>
                                                <p class="price-list">Platinum Pass</p>
                                                <span class="event-date">The decade that brought</span>
                                            </div>
                                            <div class="price-list-price">
                                                <span>$49</span>
                        ...
                        <div class="col-lg-5 pl-32 md-pl-15">
                            <div class="rs-contact home-style1">
            ...
            <div id="sponsor" class="rs-our-sponsor style1 bg8 pt-120 pb-120 md-pt-75 md-pb-80">
                <div class="container">
                    ...
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="true" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="true" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="true" data-md-device="3" data-md-device-nav="false" data-md-device-dots="true">
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                               <ul class="blog-meta">
                                   ...
                                   <li class="cat-list"><a href="blog-details.html"> <i class="fa fa-folder"></i>E-commerce</a></li>
                               </ul>
                               <h3 class="blog-title"><a href="blog-details.html">Learning to Take Your Life Into Your Own Hands</a></h3>
                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                               ...
                               <h3 class="blog-title"><a href="blog-details.html">Arnold Sports Festival set for UK debut at the NEC club</a></h3>
                               <div class="blog-button">
                                   <a href="blog-details.html">
                                       <span class="btn-txt">Read More</span>
                                       <i class="fa fa fa-chevron-right"></i>
                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                               ...
                               <h3 class="blog-title"><a href="blog-details.html">What Do Live Music Fan Think About This First Month</a></h3>
                               <div class="blog-button">
                                   <a href="blog-details.html">
                                       <span class="btn-txt">Read More</span>
                                       <i class="fa fa fa-chevron-right"></i>
                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                               ...
                               <h3 class="blog-title"><a href="blog-details.html">Event Technology Awards For People’s Choice Vote</a></h3>
                               <div class="blog-button">
                                   <a href="blog-details.html">
                                       <span class="btn-txt">Read More</span>
                                       <i class="fa fa fa-chevron-right"></i>
                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                               ...
                               <h3 class="blog-title"><a href="blog-details.html">The 5 Best Mobile Ordering The Apps For Events Fest</a></h3>
                               <div class="blog-button">
                                   <a href="blog-details.html">
                                       <span class="btn-txt">Read More</span>
                                       <i class="fa fa fa-chevron-right"></i>
                        ...
                        <div class="blog-item">
                            ...
                            <div class="blog-content">
                               ...
                               <h3 class="blog-title"><a href="blog-details.html">ICC Wales Reports Record Breaking Summer</a></h3>
                               <div class="blog-button">
                                   <a href="blog-details.html">
                                       <span class="btn-txt">Read More</span>
                                       <i class="fa fa fa-chevron-right"></i>
            ...
            <div class="rs-contact home-style1 pt-110 pb-120 md-pt-70 md-pb-80" id="contact">
                <div class="container">
                    <div class="sec-title text-center mb-85 md-mb-50">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-4 col-md-6 md-mb-30">
                                <div class="services-item">
                                   <div class="services-img">
                                       <img src="assets/images/services/style1/1.jpg" alt="images">
                                   </div>
                                   <div class="services-text">
                                       <h2 class="title">The Empire Hotel</h2>
                                       <div class="services-part mb-15">
                                           <div class="services-icon">
                                               <img src="assets/images/services/style1/icons/pin.png" alt="">
                                           </div>
                                           <p class="services-txt"> 55 New Street, Grand Lane, New York City, NY 11201</p>
                                       </div>
                                       <div class="addon-services">
                                           <div class="services-icon">
                                               <img src="assets/images/services/style1/icons/price.png" alt="">
                                           </div>
                                           <p class="services-txt">$55-$350</p>
                                       </div>
                            ...
                            <div class="col-lg-4 col-md-6 sm-mb-30">
                                <div class="services-item">
                                   <div class="services-img">
                                       <img src="assets/images/services/style1/2.jpg" alt="images">
                                   </div>
                                   <div class="services-text">
                                       ...
                                       <div class="services-part mb-15">
                                           ...
                                           <p class="services-txt">88 Old Street, Old Lane, New York City, NY 11205</p>
                                       </div>
                                       <div class="addon-services">
                                           <div class="services-icon">
                                               <img src="assets/images/services/style1/icons/price.png" alt="">
                                           </div>
                                           <p class="services-txt">$120-$666</p>
                                       </div>
                                       <div class="blog-button service mt-24">
                                           <a href="#">
                                               <span class="btn-txt">Get Directions</span>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="services-item">
                                   <div class="services-img">
                                       <img src="assets/images/services/style1/3.jpg" alt="images">
                                   </div>
                                   <div class="services-text">
                                       <h2 class="title">The Earlington Hotel</h2>
                                       <div class="services-part mb-15">
                                           <div class="services-icon">
                                               <img src="assets/images/services/style1/icons/pin.png" alt="">
                                           </div>
                                           <p class="services-txt">99 New Street, Old Lane, New York City, NY 11221</p>
                                       </div>
                                       <div class="addon-services">
                                           <div class="services-icon">
                                               <img src="assets/images/services/style1/icons/price.png" alt="">
                                           </div>
                                           <p class="services-txt">$200-$1500</p>
                                       </div>
                                       <div class="blog-button service mt-24">
                                           <a href="#">
                                               <span class="btn-txt">Get Directions</span>
